<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FacultyReview.aspx.cs" Inherits="ems_app.modules.faculty.FacultyReview" %>
...
<head>
    ...
    <title>Articulations Pending Review</title>
    <!-- Bootstrap -->
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" LoadingPanelID="RadAjaxLoadingPanel1" OnAjaxRequest="RadAjaxPanel1_AjaxRequest">
            ...
            <div class="row" style="padding: 10px;">
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <h2>Articulations Pending Review</h2>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6 text-right" style="padding-right: 10px;">
                    <telerik:RadLabel ID="rlUser" runat="server"></telerik:RadLabel>
                    &nbsp;
                    <telerik:RadButton runat="server" ID="rbHomepage" ButtonType="StandardButton" Text="MoveForward" OnClick="rbHomepage_Click">
                    <ContentTemplate>
                        <i class='fa fa-back'></i> Go to Homepage
                    </ContentTemplate>
                </telerik:RadButton>
                    &nbsp;
                <telerik:RadButton runat="server" ID="btnLogout" OnClientClick="javascript:if(!confirm('Are you sure you want to logout ?')){return false;}" ButtonType="StandardButton" Text="MoveForward" OnClick="btnLogout_Click">
                    <ContentTemplate>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" Width="99%" RenderMode="Lightweight">
                        <telerik:RadPageView runat="server" ID="RadPageView1" Width="100%">
                            <telerik:RadGrid ID="rgFacultyReviewArticulations" runat="server" AllowSorting="True" AutoGenerateColumns="False" Culture="es-ES" DataSourceID="sqlFacultyReviewArticulations" AllowFilteringByColumn="true" AllowPaging="True" GroupingSettings-CaseSensitive="false" OnItemCommand="rgFacultyReviewArticulations_ItemCommand" RenderMode="Lightweight" OnItemDataBound="rgFacultyReviewArticulations_ItemDataBound" AllowMultiRowSelection="true">
                                <ClientSettings AllowRowsDragDrop="false" AllowColumnsReorder="true" ReorderColumnsOnClient="true" EnableRowHoverStyle="false">
                                    ...
                                    <ClientEvents OnRowContextMenu="demo.RowContextMenu" OnFilterMenuShowing="FilterMenuShowing" />
                                </ClientSettings>
                        ...
                        <telerik:RadPageView runat="server" ID="RadPageView2" Width="100%">
                            <telerik:RadGrid ID="rgUserLog" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" Culture="es-ES" DataSourceID="sqlUserLog" EnableHeaderContextMenu="True" Width="100%" AllowFilteringByColumn="true" PageSize="50" GridLines="None">
                                <ClientSettings>
    ...
    <script>
        ; (function ($, undefined) {
            ...
            demo.RowContextMenu = function (sender, eventArgs) {
                ...
                document.getElementById("hvOutlineID").value = outline_id;
                document.getElementById("hvID").value = id;
                document.getElementById("hvArticulationID").value = articulation_id;
                document.getElementById("hvArticulationType").value = articulation_type;
                document.getElementById("hvArticulationStage").value = articulation_stage;
                document.getElementById("hvAceID").value = ace_id;
                document.getElementById("hvTeamRevd").value = team_revd;
                document.getElementById("hvTitle").value = title;
    ...
    <script type="text/javascript">
        ...
        function ApprovedArticulations() {
            ...
            guiders.createGuider({
                ...
                description: "Click here to display all active articulations.",
                id: "guiderApprove2",
                next: "guiderApprove3",
                position: 3,
                title: "Approve Articulations",
        ...
        function DennyArticulations() {
        }

        function ReturnArticulations() {
        }

        function RecentUserActivity() {
            guiders.createGuider({
                buttons: [{ name: "Next" }],
                description: "Introduction text for Recent User Activity",
                id: "guider1",
                next: "guider2",
                overlay: true,
            ...
            guiders.createGuider({
                attachTo: ".RecentUserActivity",
                buttons: [{ name: "EXIT", onclick: guiders.hideAll },
                { name: "BACK" },
                    { name: "NEXT", classString: "guiders_primary_button", onclick: guiders.next }],
                description: "Click on Recent User Activity tab",
                id: "guider2",
                next: "guider3",
                position: 3,
                title: "Recent User Activity",
            ...
            guiders.createGuider({
                attachTo: "#rgUserLog_ctl00_ctl02_ctl03_FilterTextBox_Course",
                buttons: [{ name: "EXIT", onclick: guiders.hideAll },
                { name: "BACK" },
                    { name: "NEXT", classString: "guiders_primary_button", onclick: guiders.next }],
                description: "Click here if you want to filter user activity by course information.",
                id: "guider3",
                next: "guider4",
                position: 3,
                title: "Recent User Activity",
            ...
            guiders.createGuider({
                attachTo: "#rgUserLog_ctl00_ctl02_ctl03_FilterTextBox_Event",
                buttons: [{ name: "EXIT", onclick: guiders.hideAll },
                { name: "BACK" },
                    { name: "NEXT", classString: "guiders_primary_button", onclick: guiders.next }],
                description: "Click here if you want to filter user activity by tracking information.",
                id: "guider4",
                next: "guider6",
                position: 3,
                title: "Recent User Activity",
            ...
            guiders.createGuider({
                attachTo: "#update_anchor",
                buttons: [{ name: "Close", classString: "primary-button" }],
                description: "Great, you just reviewed the recent user activity tab.",
                id: "guider6",
                overlay: true,
                title: "Thank you!",
                width: 500
        ...
        function DeniedArticulations() {
        }

        function ArchivedArticulations() {
        }

        function AdoptArticulations() {
        }

        function ViewArticulations() {
        }
