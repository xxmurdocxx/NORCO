<%@ Page Title="" Language="C#" MasterPageFile="~/Common/templates/main.Master" AutoEventWireup="true" CodeBehind="Confirm_o.aspx.cs" Inherits="ems_app.modules.notifications.Confirm_o" %>

<%@ Register Src="~/UserControls/UnknownOccupationsNotification.ascx" TagPrefix="uc" TagName="UnknownOccupations" %>
<%@ Register Src="../../UserControls/UI/Favorites.ascx" TagName="Favorites" TagPrefix="uc1" %>
<%@ Register Src="../../UserControls/CollegeSummary.ascx" TagName="CollegeSummary" TagPrefix="uc2" %>
<%@ Register Src="../../UserControls/AuditTrail.ascx" TagName="AuditTrail" TagPrefix="uc3" %>
            ...
            <div class="row" style="margin-bottom: 50px;">
                <div class="col-8">
                    <h3 class="section-to-print-title">
                        ...
                        <label style="font-weight:bolder">Criteria:</label>
                        <label id="lblCriteria" runat="server" style="margin: 3px;"></label>
                    </h3>
                </div>
            </div>
