<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmAdoptArticulation.aspx.cs" Inherits="ems_app.modules.popups.ConfirmAdoptArticulation" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <div style="padding: 15px;">
                ...
                <div class="row">
                    <telerik:RadLabel ID="rlMsg" runat="server" Font-Bold="true"></telerik:RadLabel>
                </div>
                <div class="row">
                    ...
                    <telerik:RadComboBox ID="rcbStages" runat="server" Culture="es-ES" DataSourceID="sqlStages" DataTextField="RoleName" DataValueField="id" Label="Select a stage : " Text="Select a Stage : " Width="330px" DropDownAutoWidth="Enabled">
                    </telerik:RadComboBox>
                </div>
                <div class="row text-right">
                    <telerik:RadButton ID="rbProceed" runat="server" Text="Proceed" CausesValidation="true" OnClick="rbProceed_Click" ValidationGroup="notification-form" ToolTip="Click here to proceed adopting articulations.">
