<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditRecommendations.aspx.cs" Inherits="ems_app.modules.popups.CreditRecommendations" %>
...
<body style="background-color: #fff;">
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <div class="row" style="padding: 20px;">
                ...
                <asp:HiddenField ID="hfAceExhibitID" runat="server" ClientIDMode="Static" />
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 d-flex justify-content-end">
                                <telerik:RadLabel ID="rlExclude" runat="server" Text="Exclude Exhibits over "></telerik:RadLabel>
                                <telerik:RadSwitch ID="rsExclude" runat="server" Width="65px" AutoPostBack="true" Checked="false" OnCheckedChanged="rsExclude_CheckedChanged">
                                    <ToggleStates>
                        ...
                        <asp:SqlDataSource runat="server" ID="sqlCriteriaDetails" ConnectionString="<%$ ConnectionStrings:NORCOConnectionString %>" ProviderName="System.Data.SqlClient" SelectCommand="GetCriteriaDetails" SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="false">
                            <SelectParameters>
                                <asp:Parameter Name="Criteria" DbType="String" />
                                <asp:ControlParameter Name="outline_id" Type="String" ControlID="hfSelectedCourse" PropertyName="Value" />
                                <asp:ControlParameter ControlID="hfExcludeArticulationOverYears" DbType="Int32" Name="ExcludeArticulationOverYears" PropertyName="Value" />
                                <asp:SessionParameter Name="SelectedAceID" SessionField="SelectedAceID" Type="String" ConvertEmptyStringToNull="true" />
                                <asp:SessionParameter Name="SelectedAceExhibitID" SessionField="SelectedAceExhibitID" Type="String" ConvertEmptyStringToNull="true"  />
                            </SelectParameters>
                        </asp:SqlDataSource>
    ...
    <script>
        ...
        function RowSelecting(sender, args) {
            if (args.get_tableView().get_name() == "ChildGridCriteria" || args.get_tableView().get_name() == "Master") {
